...
data_root = '/home/hcj_24210980089/mmdetection/data/coco/'
...
resume = False
test_cfg = dict(
    rcnn=dict(score_thr=0.5), rpn=dict(save_proposals=True), type='TestLoop')
...
test_evaluator = dict(
    ann_file=
    '/home/hcj_24210980089/mmdetection/data/coco/VOC_coco/voc12_val.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
val_evaluator = [
    dict(
        ann_file=
        '/home/hcj_24210980089/mmdetection/data/coco//annotations/voc0712_val.json',
        classwise=True,
        format_only=False,
        metric=[
            'bbox',
        ...
        outfile_prefix='./work_dirs/mask_rcnn_voc_new/val_results',
        type='CocoMetric'),
    dict(
        loss_keys=[
            'loss',
...
visualizer = dict(
    ...
    vis_backends=[
        dict(type='LocalVisBackend'),
        dict(
            save_dir='work_dirs/mask_rcnn_voc_new/tensorboard_logs',
            type='TensorboardVisBackend'),
    ])
work_dir = 'work_dirs/mask_rcnn_voc'
